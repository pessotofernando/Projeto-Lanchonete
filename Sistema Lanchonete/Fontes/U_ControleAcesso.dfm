object Fr_ControleAcesso: TFr_ControleAcesso
  Left = 239
  Top = 202
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Controle de Acesso - Usuarios'
  ClientHeight = 389
  ClientWidth = 473
  Color = clBtnFace
  ...
  object DS_CONTROLE_SP_CON: TDataSource
    DataSet = MODULE.CONTROLE_SP_CON
    Left = 288
    Top = 233
  end
