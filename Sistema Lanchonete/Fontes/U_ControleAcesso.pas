...
type
  TFr_ControleAcesso = class(TForm)
    ...
    DBGrid1: TDBGrid;
    DS_CONTROLE_SP_CON: TDataSource;
    Panel1: TPanel;
    Label1: TLabel;
    SIGLA: TEdit;
    DESCRI: TEdit;
...
begin
   ...
   with MODULE.CONTROLE_SP_SEL do
   begin
      close;
      parambyname('@INP_SIGLA').asstring := sigla.Text;
      execproc;
...
begin
   ...
   var_locate := MODULE.CONTROLE_SP_CON.FieldByName('FOR_NOME').asstring;
...
procedure TFr_ControleAcesso.CONTROLE_SP_CON;
begin
