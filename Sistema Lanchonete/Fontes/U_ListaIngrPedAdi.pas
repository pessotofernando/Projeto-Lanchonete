...
type
  TFr_ListaIngrPedAdi = class(TForm)
    DBGrid1: TDBGrid;
    DS_INGREDIENTES_SP_ADI: TDataSource;
  ...
  public
    ...
    procedure INGREDIENTES_SP_ADI;
    { Public declarations }
  end;

var
  Fr_ListaIngrPedAdi   : TFr_ListaIngrPedAdi;
  var_fr_tecla : string;
implementation
...
procedure TFr_ListaIngrPedAdi.INGREDIENTES_SP_ADI;
begin

   with Module.INGREDIENTES_SP_ADI do
   begin
      close;
...
procedure TFr_ListaIngrPedAdi.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFr_ListaIngrPedAdi.Frame_Impressao1BntFecharClick(Sender: TObject);
begin
   Close;
end;

procedure TFr_ListaIngrPedAdi.Frame_Impressao1BntGravaClick(Sender: TObject);
begin
   ...
   begin
      ...
      begin
         ...
         parambyname('@INP_CODING' ).asinteger  :=  MODULE.INGREDIENTES_SP_ADI.FieldByName('ING_CODIGO').AsInteger;
         execproc;
      end;
...
procedure TFr_ListaIngrPedAdi.Frame_Impressao1BntLimpaClick(Sender: TObject);
begin
   INGREDIENTES_SP_ADI;
end;


procedure TFr_ListaIngrPedAdi.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   Module.INGREDIENTES_SP_CON.close;
   Action := caFree;
end;

procedure TFr_ListaIngrPedAdi.FormCreate(Sender: TObject);
begin
   MODULE.INGREDIENTES_SP_CON.close;
   INGREDIENTES_SP_ADI;
end;

procedure TFr_ListaIngrPedAdi.BOXExit(Sender: TObject);
begin
   INGREDIENTES_SP_ADI;
end;

procedure TFr_ListaIngrPedAdi.ApplicationEvents1Message(var Msg: tagMSG;var Handled: Boolean);
var
  i : Smallint;
begin
